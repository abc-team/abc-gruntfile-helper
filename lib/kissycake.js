    ...
    watchInit: function(){
        ...
        if( targetInfoList.length > 1 ){
            ...
            grunt.task.registerTask( 'watch', function(){
                ...
                var done = this.async();
                var targetLen = targetInfoList.length;
                var targetCount = 0;
         ...
         */
            ...
            if( watchFor == 'page' || ( targetInfoList[0] && targetInfoList[0].type == 'page' ) ) {
            ...
            if( watchFor == 'widget' || ( targetInfoList[0] && targetInfoList[0].type == 'widget' ) ){
